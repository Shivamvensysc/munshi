...
export default function PaymentTransferForm() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      toast.error(apiError.message || "Network error. Could not process payment.");
    } finally {
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-card sm:p-7 lg:col-span-3">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <Button
              ...
              className="mt-2 bg-gradient-to-r from-violet-800 to-violet-600 py-3.5 text-sm font-bold shadow-md hover:from-violet-700 hover:to-violet-500"
            >
              Pay
            </Button>
          </form>
