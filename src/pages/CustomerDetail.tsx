...
import { ArrowLeft, Pencil, FileText, Trash2, AlertCircle } from "lucide-react";
...
type ModalType = "LENE" | "DENE" | "EDIT_CUSTOMER" | "DELETE_CONFIRM" | "MONDAY_FINAL_CONFIRM" | null;
...
export default function CustomerDetail() {
  ...
  const mapTransactionToEntry = (tx: TransactionApiData): Entry => {
    ...
    return {
      ...
      balance: numBalance,
      ...(tx.transaction_type === "LENE" ? { leneAmount: numAmount } : { deneAmount: numAmount }),
      tag: "N",
    };
  };
