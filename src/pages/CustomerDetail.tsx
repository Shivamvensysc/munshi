  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col bg-slate-50/50">
      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-4 sm:px-6">
        ...
        <div className="mb-2 grid grid-cols-12 items-center rounded-lg bg-slate-100 px-4 py-2 text-xs font-bold uppercase tracking-wider text-slate-600">
          <div className="col-span-5">Entries</div>
          <div className="col-span-2 text-right">Lene</div>
          <div className="col-span-2 text-right">Dene</div>
          <div className="col-span-3 text-right">Status / Actions</div>
          ...
          <div className="space-y-2">
            {entries.map((item) => {
              ...
              return (
                <div
                  key={item.id}
                  className="grid grid-cols-12 items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-2xs transition hover:border-slate-300"
                >
                  ...
                  <div className="col-span-3 flex items-center justify-end gap-2">
                    ...
                    >
                      {isConfirmed ? <Check size={14} strokeWidth={3} /> : "N"}
                    </button>
                    ...
                    {!isConfirmed && (
                      <div className="flex items-center gap-1">
                        <button
                          ...
                          aria-label="Edit transaction"
                          title="Edit transaction"
                          className="flex h-7 w-7 items-center justify-center rounded-full text-slate-500 hover:bg-slate-100 hover:text-indigo-600 active:scale-95"
                        >
                          <Pencil size={14} />
                        </button>
                        <button
                          ...
                          aria-label="Delete transaction"
                          title="Delete transaction"
                          className="flex h-7 w-7 items-center justify-center rounded-full text-slate-500 hover:bg-rose-50 hover:text-rose-600 active:scale-95"
                        >
                          <Trash2 size={14} />
                        </button>
                      </div>
      ...
      <footer className="sticky bottom-0 z-20 mt-auto border-t border-slate-200 bg-white/95 p-3 backdrop-blur-md">
      ...
      >
        <form onSubmit={handleCustomerUpdate} className="flex flex-col gap-4 p-5 sm:p-6">
          ...
          <div className="relative flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-3.5 py-3 transition-all focus-within:border-indigo-600 focus-within:ring-2 focus-within:ring-indigo-600/15">
            <div className="flex items-center gap-1 border-r border-slate-200 pr-3">
              <span className="inline-block text-xs font-bold text-slate-700">🇮🇳 +91</span>
